...
describe(@"MRCommand", ^{
    ...
    describe(@"MRCloseCommand", ^{
        context(@"execute", ^{
            beforeEach(^{
                command = [[[MRCloseCommand alloc] init] autorelease];
                command.delegate = mrAdView;
    ...
    describe(@"MRUseCustomCloseCommand", ^{
        context(@"execute", ^{
            beforeEach(^{
                command = [[[MRUseCustomCloseCommand alloc] init] autorelease];
                command.delegate = mrAdView;
    ...
    describe(@"MRPlayVideoCommand", ^{
        beforeEach(^{
            command = [[[MRPlayVideoCommand alloc] init] autorelease];
            command.delegate = mrAdView;
        });
    ...
    describe(@"MRStorePictureCommand", ^{
        beforeEach(^{
            command = [[[MRStorePictureCommand alloc] init] autorelease];
            command.delegate = mrAdView;
        });
    ...
    describe(@"MRCreateCalendarEventCommand", ^{
        context(@"execute", ^{
            ...
            beforeEach(^{
                command = [[[MRCreateCalendarEventCommand alloc] init] autorelease];
                command.delegate = mrAdView;
